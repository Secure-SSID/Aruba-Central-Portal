...
- If **NOT configured** → Setup Wizard appears
- If **configured** → Login page appears
...
4. **Copy These Values** (shown only once!):
   - ✅ **Client ID**: Long string (abc123def456...)
   - ✅ **Client Secret**: Long string (xyz789uvw456...)
   - ✅ **Customer ID**: Your tenant ID (a1b2c3d4...)
...
1. **Select Your Region:**
   - Choose from dropdown:
     - **United States (New Central)** ← Most common
     - **Europe (New Central)**
...
What happens next:
1. ✅ Credentials saved to `.env` file
2. ✅ Aruba Central client initialized
...
⚠️ **Important**: Using the wrong region will cause authentication failures!
...
- Go to **Settings** → **Workspace Management**
...
- Check:
  - ✅ Internet connection
  - ✅ Correct base URL for your region
  - ✅ Credentials are valid (test in Aruba Central)
...
✅ **No file editing** - Everything through UI
✅ **Guided process** - Step-by-step instructions
✅ **Region selector** - Prevents common errors
✅ **Validation** - Catches mistakes before saving
✅ **Automatic initialization** - Works immediately after save
✅ **One-time setup** - Only appears when needed
✅ **Help included** - Direct links to docs
